...
uint8_t ds18b20Sensor1[8] = { 0x28, 0xFF, 0x98, 0x29, 0x03, 0x15, 0x03, 0x37 };
uint8_t ds18b20Sensor2[8] = { 0x28, 0xFF, 0xAF, 0xA9, 0xB2, 0x16, 0x05, 0xA4 };
uint8_t ds18b20Sensor3[8] = { 0x28, 0x88, 0x21, 0x43, 0x98, 0x01, 0x02, 0x7D };

uint8_t ds18b20Sensor4[8] = { 0x28, 0x86, 0x01, 0x43, 0x98, 0x0E, 0x00, 0x32 };
uint8_t ds18b20Sensor5[8] = { 0x28, 0x15, 0x00, 0x43, 0x98, 0x0F, 0x00, 0xD3 };
uint8_t ds18b20Sensor6[8] = { 0x28, 0x33, 0x25, 0x43, 0x98, 0x24, 0x00, 0x1F };
uint8_t ds18b20Sensor7[8] = { 0x28, 0xB3, 0x0B, 0x43, 0x98, 0x01, 0x02, 0x2D };
uint8_t ds18b20Sensor8[8] = { 0x28, 0x4B, 0x18, 0x43, 0x98, 0x01, 0x02, 0xCC };
